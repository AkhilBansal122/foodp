...
<div class="col-md-3">
    <div class="form-group">
        ...
        value="{{isset($data) ? $data->lastname:''}}" 
...
<div class="col-md-3">
    <div class="form-group">
        <label for="name" class="form-label">Restaurent Name: <span style="color:red">*</span></label>
        <input type="text" name="name" value="{{isset($data) ? $data->name:''}}" class="form-control" title="Please Enter Name" placeholder="Please enter name" required id="inputname">
...
<div class="col-md-3">
    <div class="form-group">
        <label for="email" class="form-label">Email: <span style="color:red">*</span></label>
            ...
            required 
            class="form-control" 
            pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required id="email" placeholder="Test@yopmail.com" value="{{isset($data) ? $data->email:''}}">
...
<div class="col-md-3">
    <div class="form-group">
        <label for="email" class="form-label">Aadhar No: <span style="color:red">*</span></label>
            ...
            pattern="[0-9]{12}$" 
            required 
            value="{{isset($data) ? $data->aadhar_card:''}}" 
...
<div class="col-md-3">
    <div class="form-group">
        <label for="mobile_number" class="form-label">Mobile No.: <span style="color:red">*</span></label>
            ...
            name="mobile_number" 
            max="10" min="10" 
            value="{{isset($data) ? $data->mobile_number:''}}" 
...
<div class="col-md-3">
    <div class="form-group">
        <label for="other_mobile_number" class="form-label">Other Mobile No.: <span style="color:red">*</span></label>
            ...
            max="10" min="10" 
            value="{{isset($data) ? $data->other_mobile_number:''}}" 
            class="form-control "
             min="10" 
             max="12"
...
<div class="col-md-3" style="">
    <div class="form-group">
        <label for="GST" class="form-label">GST (%): <span style="color:red">*</span> </label>
            <input 
            value="{{isset($data) ? $data->GST:''}}" 
            placeholder="Please enter GST" type="text" name="GST"
             oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');"    required class="form-control" >
            @if($errors->has('GST'))<div class="error">{{ $errors->first('GST') }}</div>@endif
    </div>
</div>
<div class="col-md-3" style="">
    <div class="form-group">
        <label for="GST" class="form-label">FSSAI (license copy if you have): <span style="color:red">*</span> </label>
            <input 
            placeholder="Please enter FSSAI" type="file" name="FSSAI" 
                 class="form-control" >
            @if($errors->has('FSSAI'))<div class="error">{{ $errors->first('FSSAI') }}</div>@endif
    </div>
</div>
@if(!empty($data->FSSAI))
<div class="col-md-3" style="">
    <div class="form-group">
        <label for="FSSAI" class="form-label">FSSAI Image Preview:  </label>
        @foreach(explode(",",rtrim($data->FSSAI,",")) as $img)  
    ...
    <div class="form-group">
       <label for="passsword" class="form-label">Password: <span style="color:red">*</span> </label>
            <div class="input-group" id="show_hide_password">
                <input type="password" name="password"   value="{{isset($data) ? $data->upassword:''}}" 
...
<div class="col-xl-3">
            <div class="form-group form-check custom-checkbox mb-3 checkbox-success">
            <label for="passsword" class="form-label">With GST BILL: <span style="color:red">*</span> </label>
            <input type="checkbox" class="" {{isset($data->bill_gst) ? 'checked' :''}} name="bill_gst" id="customCheckBox3" >
    ...
    <div class="form-group">
       <label for="passsword" class="form-label">Local Address: <span style="color:red">*</span> </label>
            ...
            <textarea name="local_address" class="form-control mb-3" required style="height:116px"
                placeholder="">{{isset($data) ? $data->local_address:''}}</textarea>
            </div>
    ...
    <div class="form-group">
       <label for="passsword" class="form-label">Permanent Address: <span style="color:red">*</span> </label>
            ...
            <textarea name="permanent_address" class="form-control mb-3" required style="height:116px"
                placeholder="">{{isset($data) ? $data->permanent_address:''}}</textarea>
            </div>
...
<div class="col-12">
    ...
    <a href="{{route('admin/customer')}}" class="btn btn-primary px-5">Back</a>
</div>
