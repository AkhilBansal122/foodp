					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Sub Menu Details</h4>
                                <a href="{{route('restaurent.sub_menu.create')}}" class="btn btn-primary mt-3 mt-sm-0">
							 Add New Sub Menu</a>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <input type="text" name="restaurent_name" class="form-control searchRestaurentName" placeholder="Search for Unique Id Name Only...">
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <input type="button" id="refresh" value="Reset" class="btn btn-primary"/>
                                        </div>
                                    </div>
...
<script type="text/javascript">
  $(function () {
        ...
        serverSide: true,
        ajax: {
          url: "{{ route('restaurent/sub_menu/data') }}",
          data: function (d) {
...
function select_changes2(id,value){
    ...
    route =  "{{ route('restaurent.sub_menu.status_change') }}";
