							...
							<div class="card-body">
								<div class="table-responsive">
                                    ...
                                    <thead>
                                            ...
                                            <td>{{ $user->subject }}</td>
                                            <td>{{ $user->message }}</td>
                                            <td><button type="button" class="" data-bs-toggle="modal" data-bs-target="#exampleModal"
                                              data-bs-id="{{$user->id}}"
                                             data-bs-whatever="@mdo" style="width:50px; height: 50px; background-color: blue; border: none;">
